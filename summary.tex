...
% (The term natural is chosen for lack of a better term but is not meant to convey that acts of choice necessarily pertain to a state of nature when they are not done under arguments; also, it is not supposed to denote a value judgment about this sort of choice.) 
